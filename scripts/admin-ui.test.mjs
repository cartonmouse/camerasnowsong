...
assert.match(adminScript, /response\.album/);
assert.match(adminScript, /needs-attention/);
assert.match(adminScript, /renderTopicWarning/);
assert.match(adminScript, /topic-warning/);
assert.match(adminScript, /不会出现在“按题材”视图中/);
assert.match(adminCss, /\.album-item\.needs-attention/);
assert.match(adminCss, /\.topic-warning/);
...
assert.match(adminScript, /currentTimeLabel/);
assert.match(adminScript, /clearSaveFeedback/);
assert.match(adminScript, /flashSaveFeedback/);
assert.match(adminScript, /saveCount/);
assert.match(adminScript, /requestAnimationFrame/);
assert.match(adminScript, /toLocaleTimeString/);
