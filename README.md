...
- 网站源代码目前没有授予开源许可证。除非之后明确添加许可证，否则不得复制、修改、再发布或包装成自己的项目。
- 权限请求可以联系：`paperboxmouse@163.com`
...
公开仓库前后都需要检查 `album.json`、`homepage.json` 和 `src/data/photos.json` 是否包含不想公开的相册名、地点或描述。
